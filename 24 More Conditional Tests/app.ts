...
// Inequality Test 2
console.log("Inequality test with strings: ", ("Banana" as string) === "Banana");
...
console.log("Inequality test with number:", (804 as number) != 47);
...
// Item in array
const mobiles :string[] = ['Iphone Xr', 'Realme 5', 'Oppo A52'];
